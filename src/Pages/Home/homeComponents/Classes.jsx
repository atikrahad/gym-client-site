  ...
  return (
    <div className="max-w-screen-xl mx-auto py-20">
      ...
      <div className="grid grid-cols-1 gap-5 py-10 md:grid-cols-3 md:grid-rows-3 md:grid-flow-col">
        <div className="p-10 bg-cover min-h-64 flex items-end md:row-span-3" style={{ backgroundImage: `linear-gradient(to bottom, rgba(25, 0 , 0, .6), rgba(0, 2, 25, .59)), url(${img1})` }}>
          <div className="">
        ...
        <div className="p-10 bg-cover min-h-52 flex items-end md:col-span-2 md:row-span-2" style={{ backgroundImage: `linear-gradient(to bottom, rgba(25, 0 , 0, .6), rgba(0, 2, 25, .59)), url(${img2})` }}>
          <div className="">
            <h1 className="text-2xl font-semibold text-white">Body Building</h1>
            <p className="text-slate-300">
              Start build your body with body building class
        ...
        <div className="p-10 bg-cover min-h-52 flex items-end " style={{ backgroundImage: `linear-gradient(to bottom, rgba(25, 0 , 0, .6), rgba(0, 2, 25, .59)), url(${img3})` }}>
          <div className="">
            <h1 className="text-2xl font-semibold text-white">Body Building</h1>
            <p className="text-slate-300">
              Start build your body with body building class
        ...
        <div className="p-10 bg-cover min-h-52 flex items-end" style={{ backgroundImage: `linear-gradient(to bottom, rgba(25, 0 , 0, .6), rgba(0, 2, 25, .59)), url(${img4})` }}>
          <div className="">
            <h1 className="text-2xl font-semibold text-white">Body Building</h1>
            <p className="text-slate-300">
              Start build your body with body building class
